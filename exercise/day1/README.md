...
- [Participant assignment](participant-assignment.md): no expected values or rubric.
- [Facilitator guide](facilitator-guide.md): expected results and rubric. Keep it
  separate from the participant assignment and do not supply it to the agent.
